    ...
    <FormControlLabel
        control={
          <Checkbox
            color="primary"
            name="Laptop & Mac"
            checked={categoryFilters.category.includes('Laptop & Mac')}
          ...
          <FormControlLabel
                control={
                          <Checkbox
                            color="primary"
                            name="Mobile & Tablet"
                            checked={categoryFilters.category.includes('Mobile & Tablet')}
                     ...
                     onChange={(e) => handleCheckboxChange(e.target.name, e.target.checked)}
                        ...
                        label={
                          <Typography variant="caption" sx={{ fontSize:"14px"}}>Mobile & Tablet</Typography>
                        }
                      />
                      <br/>
                      <FormControlLabel
                        control={
                          <Checkbox
                            color="primary"
                            name="HOME DEVICES"
                            checked={categoryFilters.category.includes('HOME DEVICES')}
                           onChange={(e) => handleCheckboxChange(e.target.name, e.target.checked)}
                        ...
                        label={
                          <Typography  variant="caption" sx={{ fontSize:"14px"}} >Home Devices</Typography>
}/>
                      ...
                      <br/>
                        ...
                        control={
                          <Checkbox
                            ...
                            color="primary"
                            name="Fitness"
                            checked={categoryFilters.category.includes('Fitness')}
                            onChange={(e) => handleCheckboxChange(e.target.name, e.target.checked)}
                              sx={Mainstyle.checkboxsubheading}
                          />
                        }
                        label={
                          <Typography variant="caption" sx={{ fontSize:"14px"}}>Fitness</Typography>
                         }
                      />
                      <br/>
                            <FormControlLabel
                        control={
                          <Checkbox
                            ...
                            color="primary"
                            name="Games & Toys"
                            checked={categoryFilters.category.includes('Games & Toys')}
                           onChange={(e) => handleCheckboxChange(e.target.name, e.target.checked)}
                             sx={Mainstyle.checkboxsubheading}
                          />
                        }
                        label={
                          <Typography variant="caption" sx={{ fontSize:"14px"}}>Games & Toys</Typography>
                       }/>
                            <FormControlLabel
                        control={
                          <Checkbox
                            ...
                            color="primary"
                            name="TV & Audio"
                            checked={categoryFilters.category.includes('TV & Audio')}
                          onChange={(e) => handleCheckboxChange(e.target.name, e.target.checked)}
                        ...
                        label={
                          <Typography variant="caption" sx={{ fontSize:"14px"}}>TV & Audio</Typography>
                      }
                      />
                      <br />
                              <FormControlLabel
                        control={
                          <Checkbox
                            ...
                            color="primary"
                            name="Accessories"
                            checked={categoryFilters.category.includes('Accessories')}
                          onChange={(e) => handleCheckboxChange(e.target.name, e.target.checked)}
                        ...
                        label={
                          <Typography variant="caption" sx={{ fontSize:"14px"}} >Accessories</Typography>
                        ...
                        control={
                          <Checkbox
                            ...
                            color="primary"
                            name="Security"
                            checked={categoryFilters.category.includes('Security')}  
                     ...
                     onChange={(e) => handleCheckboxChange(e.target.name, e.target.checked)}
                        ...
                        label={
                          <Typography  variant="caption" sx={{ fontSize:"14px"}}>Security</Typography>
                       }
                      />
                    </div>
                  ),
